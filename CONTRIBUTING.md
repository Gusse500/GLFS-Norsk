...
book.
#### 3.1.1.3. `download/`
This directory contains downloads that may be required by other packages such
as patches or scripts.
#### 3.1.1.4. `images/`
...
#### 3.1.1.6. `patches/`
Symlink to `download/`. Needed for compatibility with older book renders.
#### 3.1.1.7. `stylesheets/`
